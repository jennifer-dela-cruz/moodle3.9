...
class mod_quiz_renderer extends plugin_renderer_base {
     ...
     * @param int $nextpage The number of the next page
     */
    public function system_prechecks_page($attemptobj, $page, $accessmanager, $messages, $slots, $id,
            $nextpage, $test) {
        $output = '';
        $output .= $this->header();
        $output .= $this->quiz_notices($messages);
     ...
     * @param int $nextpage The number of the next page
     */
    public function final_instructions_page($attemptobj, $page, $accessmanager, $messages, $slots, $id,
            $nextpage, $test) {
        $output = '';
        $output .= $this->header();
        $output .= $this->quiz_notices($messages);
        $output .= $this->final_instructions_form($attemptobj, $page, $slots, $id, $nextpage, $test);
        $output .= $this->footer();
        return $output;
    }
    ...
    /**
     * Ouputs the form for system prechecks
     *
     * @param quiz_attempt $attemptobj
     * @param int $page Current page number
     * @param array $slots Array of integers relating to questions
     ...
     * @param int $nextpage Next page number
     */
    public function system_prechecks_form($attemptobj, $page, $slots, $id, $nextpage, $test) {
        $output = '';
    ...
    /**
     * Ouputs the form for identity face prechecks
     *
     * @param quiz_attempt $attemptobj
     * @param int $page Current page number
     * @param array $slots Array of integers relating to questions
    ...
    public function identity_face_prechecks_form($attemptobj, $page, $slots, $id, $nextpage, $user_id, $quiz_id) {
        ...
        // Start the form
        $output .= html_writer::start_tag('form',
                array('action' => new moodle_url($attemptobj->processidentityfacechecks_url(),
                array('cmid' => $attemptobj->get_cmid())), 'method' => 'post',
                'enctype' => 'multipart/form-data', 'accept-charset' => 'utf-8',
                'id' => 'responseform'));
    ...
    /**
     * Ouputs the form for id face prechecks
     *
     * @param quiz_attempt $attemptobj
     * @param int $page Current page number
     * @param array $slots Array of integers relating to questions
    ...
    public function identity_id_prechecks_form($attemptobj, $page, $slots, $id, $nextpage, $user_id, $quiz_id) {
        ...
        // Start the form
        $output .= html_writer::start_tag('form',
                array('action' => new moodle_url($attemptobj->processidentityidchecks_url(),
                array('cmid' => $attemptobj->get_cmid())), 'method' => 'post',
                'enctype' => 'multipart/form-data', 'accept-charset' => 'utf-8',
                'id' => 'responseform'));
    ...
    /**
     * Ouputs the form for final instructions
     *
     * @param quiz_attempt $attemptobj
     * @param int $page Current page number
     * @param array $slots Array of integers relating to questions
     ...
     * @param int $nextpage Next page number
     */
    public function final_instructions_form($attemptobj, $page, $slots, $id, $nextpage, $test) {
        $output = '';
        ...
        $output .= $test;
        // ADD HERE THE QUIZ AND PRECHECK INSTRUCTIONS
        $output .= html_writer::tag('p', get_string('finalinstructions_header', 'quiz'));
        $output .= html_writer::tag('p', get_string('finalinstructions', 'quiz'));

        // Start the form
        $output .= html_writer::start_tag('form',
                array('action' => new moodle_url($attemptobj->proceedattempt_url(),
                array('cmid' => $attemptobj->get_cmid())), 'method' => 'post',
                'enctype' => 'multipart/form-data', 'accept-charset' => 'utf-8',
                'id' => 'responseform'));
        $output .= html_writer::start_tag('div');
        ...
        // ATTEMPT QUIZ BUTTON
        $output .= html_writer::empty_tag('input', array('type' => 'submit', 'name' => 'proceedattemptquiz_btn',
                'value' => get_string('proceedattemptquiz_btn', 'quiz'), 'class' => 'mod_quiz-next-nav btn btn-primary'));
    ...
    public function attempt_auto_proctor_form($attemptobj, $page, $slots, $id, $nextpage, $user_id, $quiz_id) {
        ...
        // Start the form.
        $output .= html_writer::start_tag('form',
                array('action' => new moodle_url($attemptobj->processattempt_auto_proctor_url(),
                array('cmid' => $attemptobj->get_cmid())), 'method' => 'post',
                'enctype' => 'multipart/form-data', 'accept-charset' => 'utf-8',
                'id' => 'responseform'));
        $output .= html_writer::start_tag('div');
    ...
    public function attempt_snap_proctor_form($attemptobj, $page, $slots, $id, $nextpage, $user_id, $quiz_id) {
        ...
        // Start the form.
        $output .= html_writer::start_tag('form',
                array('action' => new moodle_url($attemptobj->processattempt_snap_proctor_url(),
                array('cmid' => $attemptobj->get_cmid())), 'method' => 'post',
                'enctype' => 'multipart/form-data', 'accept-charset' => 'utf-8',
                'id' => 'responseform'));
        $output .= html_writer::start_tag('div');
